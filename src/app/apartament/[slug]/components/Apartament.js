...
const Apartament = () => {
    return (
        <><div className="my-10">
            <Image src='/LatestOffers/test.png' width="580" height="414" alt="img-Apartament" className="mx-[auto] md:w-[580px]" />
            <div
                className="w-[10.125rem] md:w-[11.5rem] mx-[auto] flex gap-6 items-center mt-6"
            >
                <button
                    className="w-3 h-3 bg-blue1 rounded-[100%] block md:w-4 md:h-4"
                ></button>
                <button
                    className="w-3 h-3 bg-blue1 rounded-[100%] block md:w-4 md:h-4"
                ></button>
                <button
                    className="w-[1.125rem] h-[1.125rem] bg-blue rounded-[100%] block md:w-6 md:h-6"
                ></button>
                <button
                    className="w-3 h-3 bg-blue1 rounded-[100%] block md:w-4 md:h-4"
                ></button>
