      ...
      <div className="lg:flex lg:gap-[7.5rem]">
        <div className="flex flex-col gap-4 lg:w-[36.25rem] font-Comfortaa text-xl md:text-2xl md:font-semibold md:leading-[1.8rem] font-medium leading-[1.5rem]">
          ...
          <p className="text-base font-light font-Manrope md:text-xl">
            ...
            fridge/freezer, dishwasher and washing machine. The lounge and hall
            has laminate flooring and the two double bedrooms are carpeted. The
            master bedroom comes with an ensuite bathroom with walk in shower.
            The bathroom also has a shower over the bath.
          </p>
        </div>
