        ...
        <>
            <li className="mt-8 md:mt-10">
                <div className="relative flex justify-center">
                    <Image src="/LatestOffers/test.png" width="328" height="336" alt="photo" />
                    <div
                    ...
                    >
                        ...
                        <div className="flex gap-[1.12rem]">
                            <Image src="/LatestOffers/carbon_floorplan.svg" width="24" height="24" alt="plan" />
                ...
                >
                    ...
                    >
                        ...
                        <p className="flex gap-1">
                            <span>
                                <Image src="/LatestOffers/star.svg" width="18" height="18" alt="starSvg" className="rounded-[100%]" />
                            </span>4.9
                        </p>
                    </a>
