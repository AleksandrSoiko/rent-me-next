...
const RentBuySelect = () => {
  ...
  return (
    <section className="flex flex-col items-center mx-4 max-md:py-[1.44rem] md:pb-16">
      ...
      <div className="flex max-lg:flex-col w-[328px] md:w-[704px] lg:w-[1180px] py-6 lg:px-10 md:py-8 gap-4 md:gap-8 rounded-[0.75rem] mt-3 md:mt-4 shadow-[-4px_-4px_8px_0px_rgba(215,229,255,0.4),4px_4px_8px_0_rgba(215,229,255,0.4)]">
