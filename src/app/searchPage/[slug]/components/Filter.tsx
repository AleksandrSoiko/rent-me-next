...
const addedArrayBtnName: string[] = [
  "Any time",
  "24 hours",
  "3 days",
  "7 days",
...
const Filter: React.FC<FilterProps> = ({ openFilter, setOpenFilter }) => {
  ...
  return (
    <div className="truncate pb-4 pl-4 pr-4 ">
      ...
      >
        <div
          className={`md:grid px-6 lg:px-10 pt-4  grid-cols-2 max-md:flex  max-md:flex-col max-md:gap-4 md:gap-8 lg:gap-5 justify-center `}
        >
