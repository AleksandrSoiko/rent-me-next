...
const Filter = () => {
    ...
    return (
        <><div
            className="px-6 lg:px-10 mt-4 lg:mt-10 grid-cols-2 max-md:flex md:grid max-md:flex-col max-md:gap-4 md:gap-8 lg:gap-5 justify-center"
        >
            <div
                className="flex flex-col md:w-[20rem] lg:w-[33.75rem] lg:h-[18.18rem]"
            >
            ...
            <div
                className="flex flex-col md:w-[20rem] lg:w-[33.75rem] lg:h-[18.18rem]"
            >
                <p className="font-ComhtmlFortaa text-lg leading-[1.35rem] mb-2">Price</p>
                <div className="flex gap-5 max-md:justify-center">
                    <label
                        htmlFor="minP"
                        className="relative font-Manrope text-base leading-[1.2rem]"
            ...
            <div className="flex flex-col md:w-[20rem] lg:w-[33.75rem] items-start">
                ...
                >
                    <button
                        className="border-[1px] border-blue1 text-center w-[50%] py-2 bg-blue text-[#fff]"
                    >
                        Any
                    </button>
                    <button
                        className="border-[1px] border-blue1 text-center w-[50%] py-2 text-[#444]"
                    >
                        Part furnished
                    </button>
                    <button
            ...
            <div className="flex flex-col md:w-[20rem] lg:w-[33.75rem]">
                ...
                >
                    <button
                        className="border-[1px] border-blue1 text-center w-[50%] py-2"
                    >
                        Any
                    </button>
                    <button
                    ...
                    <button
                        className="border-[1px] border-blue1 text-center w-[50%] py-2 text-[#444] bg-blue "
                    >
                        3 days
                    </button>
                    <button
