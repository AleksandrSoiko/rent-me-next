    ...
    return (
        <form action="" className="flex flex-col gap-6 w-[100%] relative">
            ...
            <input
                ...
                className="w-[100%] py-4 px-4 tex-base font-medium border-[1px] border-[#000] rounded-[0.5rem]"
            />
            <button type="button" onClick={() => setPassHidden(!passHidden)}> <Image src='/eye.svg' width="32" height="23" alt="eye" className="absolute top-[100px] right-4" /></button>
            <Link
                href="signIn/ForgotPassword"
                className="font-Manrope font-medium underline text-base"
